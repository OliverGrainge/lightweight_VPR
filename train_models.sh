...
#train vgg16
#python train.py --backbone=vgg16 --aggregation=mac --dataset_name=mapillary_sls --num_workers=16 --save_dir=vgg16_mac_1024 --QAT=False --train_batch_size=2 --infer_batch_size=2 --mixed_precision_training=False --accrue_gradient=1 --fc_output_dim=1024

#train resnet101
#python train.py --backbone=resnet101conv4 --aggregation=mac --dataset_name=mapillary_sls --num_workers=16 --save_dir=resnet101_mac_1024 --QAT=False --train_batch_size=2 --infer_batch_size=2 --mixed_precision_training=False --accrue_gradient=1 --fc_output_dim=1024

# training mobilenet
#python train.py --backbone=mobilenetv2conv4 --aggregation=mac --dataset_name=mapillary_sls --num_workers=16 --save_dir=mobilenetv2conv4_mac_1024 --QAT=False --train_batch_size=2 --mixed_precision_training=False --accrue_gradient=1 --infer_batch_size=2 --fc_output_dim=1024

# training resnet50
#python train.py --backbone=resnet50conv4 --aggregation=mac --dataset_name=mapillary_sls --num_workers=16 --save_dir=resnet50_mac_1024 --QAT=False --train_batch_size=2 --infer_batch_size=2 --mixed_precision_training=Frue --accrue_gradient=1 --fc_output_dim=1024

# training efficientnet:
#python train.py --backbone=efficientnet_b0 --aggregation=mac --dataset_name=mapillary_sls --num_workers=16 --save_dir=efficientnetb0_mac_1024 --QAT=False --train_batch_size=2 --infer_batch_size=2 --accrue_gradient=1 --mixed_precision_training=False --fc_output_dim=1024 --resume=/home/oliver/Documents/github/lightweight_VPR/logs/efficientnetb0_mac_1024/2023-10-02_05-36-39/best_model.pth

# training resnet18
#python train.py --backbone=resnet18conv4 --aggregation=mac --dataset_name=mapillary_sls --num_workers=16 --save_dir=resnet18_mac_1024 --QAT=False --train_batch_size=2 --infer_batch_size=2 --accrue_gradient=1 --mixed_precision_training=False --fc_output_dim=1024

# training shufflenet 
#python train.py --backbone=squeezenet --aggregation=mac --dataset_name=mapillary_sls --num_workers=16 --save_dir=squeezenet_mac_1024 --QAT=False --train_batch_size=2 --infer_batch_size=2 --mixed_precision_training=False --accrue_gradient=1 --fc_output_dim=1024
